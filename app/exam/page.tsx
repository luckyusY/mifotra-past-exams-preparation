...
import { ictPaperQuestions } from '@/lib/questions';
  ...
  return (
    <>
      ...
      <p className="lead" style={{ marginBottom: '1.2rem' }}>
        {ictPaperQuestions.length} questions, 2 hours, marks weighted 1&ndash;4 exactly as in the
        original sitting. Answers and explanations appear as you go.
      </p>
      <ExamRunner
        questions={ictPaperQuestions}
